...
export default function SeoAdmin({
  ...
  const [data, setData] = useState({
    titleEn:
      initialData.titleEn || "Data Center Technical Cleaning - ISO 14644",
    metaDes:
      initialData.metaDes ||
      "I'm Ashraf Almuhtaseb, a Data Center Cleaning Expert dedicated to enhancing operational efficiency and sustainability through professional, high-standard cleaning solutions. My focus is on achieving the perfect balance between precision, reliability, and performance continuity.Meta Description",
    keywords:
      initialData.keywords ||
      "portfolio,Data Center Cleaning,Data Center,Ashraf Almuhtaseb,أشرف المحتسب",
    image: initialData.image || "/image.png",
  });
      ...
      <div className="rounded-lg border p-5 flex flex-col gap-5 bg-white mt-10 shadow-sm">
        ...
        <div className="grid grid-cols-2 mt-5 gap-5">
          ...
          <div className="flex flex-col gap-4">
            {[
              { id: "titleEn", label: "عنوان الصفحة (إنحليزي) ", dir: "ltr" },
              {
                id: "metaDes",
                label: "وصف الصفحة (إنحليزي) ",
                type: "textarea",
                dir: "ltr",
              },
              {
